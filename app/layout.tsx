  ...
  return (
    <html lang="id" suppressHydrationWarning>
      <head>
        ...
        <meta name="theme-color" content="#1F6B77" />
      ...
      <body className={`${inter.variable} antialiased`}>
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[999] focus:px-6 focus:py-3 focus:bg-[#1F6B77] focus:text-white focus:rounded-lg focus:shadow-2xl focus:font-semibold"
        >
        ...
        <a
          ...
          className="fixed bottom-6 right-6 z-50 w-14 h-14 flex items-center justify-center rounded-full shadow-lg transition-all duration-300 hover:scale-110 active:scale-95 focus:outline-none focus:ring-4 focus:ring-[#1F6B77]/50 focus:ring-offset-2"
          style={{
            background: "#1F6B77",
            boxShadow: "0 8px 20px rgba(31, 107, 119, 0.35)",
          }}
        ...
        >
          ...
          <span className="absolute inset-0 rounded-full bg-[#1F6B77] opacity-75 animate-ping" aria-hidden="true"></span>
        </a>
      </body>
    </html>
  )
