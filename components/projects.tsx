...
export default function Projects() {
  ...
  const Modal = () => {
    ...
    return (
      ...
      >
        <div
          className="bg-white border border-[#2A8E9E]/20 rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-in zoom-in-95"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Close Button */}
          <div className="sticky top-0 bg-white border-b border-[#2A8E9E]/20 p-6 flex items-center justify-between">
          ...
          <div className="p-6 space-y-5">
            {/* Image */}
            <div className="h-64 md:h-80 bg-gradient-to-br from-[#2A8E9E]/10 to-[#180D39]/5 rounded-lg flex items-center justify-center border border-[#2A8E9E]/10 overflow-hidden relative">
          ...
          {projects.map((project) => (
            ...
            >
              ...
              <div className="relative bg-white border border-[#2A8E9E]/20 rounded-lg overflow-hidden hover:border-[#2A8E9E]/40 transition-all duration-500 hover:shadow-lg hover:shadow-[#2A8E9E]/10 h-full flex flex-col">
                {/* Image */}
                <div className="aspect-[16/9] bg-gradient-to-br from-[#2A8E9E]/10 to-[#180D39]/5 relative overflow-hidden flex items-center justify-center group-hover:from-[#2A8E9E]/15 group-hover:to-[#180D39]/10 transition-all duration-500">
                  {project.image ? (
                    <Image 
                      src={project.image} 
                      alt={project.title}
