    ...
    <section id="about" ref={sectionRef} className="py-20 bg-background relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${
          ...
          <div className="inline-flex items-center gap-1 bg-foreground/5 backdrop-blur-sm text-foreground px-3 py-1.5 rounded-full text-xs font-medium border border-foreground/10 hover:border-foreground/20 transition mb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className={`transition-all duration-1000 ${
            ...
            <div className="bg-card border border-foreground/10 rounded-2xl p-8 shadow-lg hover:shadow-xl transition relative overflow-hidden">
              ...
              <div className="flex flex-col items-center relative z-10">
                <div className="relative mb-6 group">
                  ...
                  <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 bg-green-500 text-white px-3 py-1 rounded-full text-xs font-medium shadow-lg flex items-center gap-1.5 group-hover:scale-105 transition">
          ...
          <div className={`space-y-6 transition-all duration-1000 delay-200 ${
            ...
            <div className="space-y-4 pt-2">
              ...
              <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
                Saya menggunakan <strong>WordPress</strong> untuk solusi cepat, dan <strong>Custom Development</strong> (Spring Boot, Laravel) untuk kebutuhan yang lebih spesifik.
              </p>
            </div>
